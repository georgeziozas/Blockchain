...
library PriceConverter {
    ...
    function getPrice() internal view returns(uint256){
        //Since we will be interacting with an interface of chainlink which is essentially a contract
        //we will need 2 things: Address : 0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e && ABI: import "@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol"
